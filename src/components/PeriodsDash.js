...
import Tasks from './Tracker/Tasks';
import AddTask from './Tracker/AddTask';
...
function PeriodsDash() {
    ...
    const addTask = (task) => {
        ...
        // var templateParams = {
        //     user_name: `${task.text}`,
        //     user_email: 'prashantsetia888@gmail.com',
        //     message:'hihihihihi'
        // };
        // // ++++++++++++++++++++++++++++
        ...
        Swal.fire({
            icon: 'success',
            title: 'Yay...',
            text: 'You have successfully saved a new detail!'
        })
    ...
    const editTask = (id) => {
        ...
        Swal.fire({
            icon: 'success',
            title: 'Yay...',
            text: 'You have successfully edited an existing data!'
        })
        ...
        <>
            {
                loading
                    ...
                    <div className="containeri">
                        ...
                        {/* Task Counter */}
                        <h3>Data Available: {tasks.length}</h3>
